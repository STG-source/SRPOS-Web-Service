...
class PoviewService {
	 ...
	 * @return stdClass
	 */
	public function getPoviewByID($itemID) {
	 ...
	 * @return void
	 */
	public function deletePoview($itemID) {
	 ...
	 * @return array
	 */
	public function getPoview_paged($startIndex, $numItems) {
	...
	/**
	 * Returns distinct itemCatagoryIndex from all elements (KP)
	 *
	 * Add authorization or any logical checks for secure access to your data 
	 *
	 * 
